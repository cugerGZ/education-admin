    ...
    >
      ...
      <el-table-column label="操作" align="center" width="240px" class-name="small-padding fixed-width">
        <template slot-scope="{ row, $index }">
          <el-button type="primary" size="mini" @click="opnedetail(row)">
            目录
          </el-button>
          ...
          <el-popconfirm title="是否删除该专栏？" style="margin-left: 10px;" @onConfirm="handleDelete(row, $index)">
    ...
    <el-dialog fullscreen :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label="课程介绍" prop="try">
          <el-input v-model="temp.try" type="textarea" :rows="3" placeholder="请输入课程介绍" />
        </el-form-item>
